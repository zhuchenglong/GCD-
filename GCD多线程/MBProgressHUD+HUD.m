...
//显示菊花+文字
+(void)showLoadHUDMsg:(NSString *)message fromView:(UIView *)view{
    
    dispatch_async(dispatch_get_main_queue(), ^{
        [MBProgressHUD hideHUDFromView:view];
...
/** 环形进度条+文字 **/
+(void)showCircularHUDProgress:(UIView *)view{
...
/** 更新progress进度 **/
+(MBProgressHUD *)getHUDProgressFromView:(UIView *)view{
...
/** 自定义图片 + 文字 **/
+(void)showCustomViewFrom:(UIView *)view msg:(NSString *)msg imageName:(NSString *)imageName{
